...
window.CATALOGOS = (function () {
  ...
  // ---------------------------------------------------------------
  // DEPARTAMENTOS (33 entidades). Los 7 primeros son de aparición
  // prioritaria según el documento maestro, pero el registro no se
  // limita a ellos: el resto del país está disponible completo.
  // ---------------------------------------------------------------
  var DEPARTAMENTOS = [
  ...
  // ---------------------------------------------------------------
  // MUNICIPIOS por departamento. Los departamentos priorizados tienen
  // una lista curada más amplia; el resto incluye su capital y la
  // opción "Otro municipio" con texto libre corto para no bloquear
  // el registro en ningún territorio del país.
  // ---------------------------------------------------------------
  var MUNICIPIOS = {
  ...
  // ---------------------------------------------------------------
  // RELACIÓN DE LA SITUACIÓN CON EL SISMO
  // ---------------------------------------------------------------
  var RELACION_SISMO = [
  ...
  // ---------------------------------------------------------------
  // QUÉ OCURRIÓ EN EL ESTABLECIMIENTO (selección múltiple, dispara
  // preguntas específicas condicionales)
  // ---------------------------------------------------------------
  var QUE_OCURRIO = [
